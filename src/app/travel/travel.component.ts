...
export class TravelComponent implements OnInit {
    ...
    getStaticMapsUrl(lat, lng, radius) {
        ...
        return url + "&markers=color:red|" + lat + "," + lng + "|&" + pathstring + "";
    ...
    copylink() {
        ...
        this.clipboard.copy("noyoupick.io/travel/" + this.roomID)
    ...
    infoButton() {
        ...
        Swal.fire({
            title: 'NoYouPick!',
            text: 'This is the lobby. Wait for the host to start, then begin swiping on your favorite travel!',
            icon: 'info',
            imageWidth: 400,
            imageHeight: 200,
        });
    ...
    copylinkalert() {
        Swal.fire({
            title: 'Welcome!',
            html: 'Share this link! <br> noyoupick.io/travel/' + this.roomID,
            icon: 'success',

...
export class ChatComponent implements OnInit {
    ...
    resetAnimationState(state, max) {
        ...
        if (this.animationState == 'swipeleft') {
            this.changevote(max, 0);
        }
        if (this.animationState == 'swiperight') {
            this.changevote(max, 1);
        }
        this.animationState = '';
        this.scalevalue = 0.9;
    }
    ...
    copylink() {
        ...
        this.clipboard.copy("noyoupick.io/restaurants/" + this.roomID)
    ...
    infoButton() {
        ...
        Swal.fire({
            title: 'NoYouPick!',
            text: 'This is the lobby. Wait for the host to start, then begin swiping on your favorite restaurants!',
            icon: 'info',
            imageWidth: 400,
            imageHeight: 200,
        });
    ...
    copylinkalert() {
        Swal.fire({
            title: 'Welcome!',
            html: 'Share this link! <br> noyoupick.io/restaurants/' + this.roomID,
            icon: 'success',
